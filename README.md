...
are supported. It is developed by [David Reid](https://github.com/mackron).
...
Finally, compile while adding the path `node_modules/miniaudio.c` to your compiler's include paths.
...
More examples can be found in the [examples](https://github.com/mackron/miniaudio/tree/master/examples) folder or online here: https://miniaud.io/docs/examples/
